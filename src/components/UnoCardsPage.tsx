  ...
  const cards: UnoCardData[] = [
    {
      ...
      number: "1",
      photoUrl: Img1,
      caption: "This is how i imagine you when you happy because of me",
    ...
    },
    {
      ...
      number: "3",
      photoUrl: Img3,
      caption: "This is how i imagine you when the kid inside you want to hug when my friends can see us :)",
      musicName: "Perfect",
      musicUrl: Music3,
    },
    {
      ...
      number: "4",
      photoUrl: Img4,
      caption: "This is how i imagine you when you are most cutest girl",
      musicName: "O Rangrez",
      musicUrl: Music4,
    },
    ...
    >
      ...
      {flipped.every((isFlipped) => isFlipped) && (
        <div className="text-center transition-all duration-500">
          ...
          >
            Well, I have written something for you Chutkuu<ChevronRight className="ml-2" />
          </button>
        </div>
      )}
    </div>
