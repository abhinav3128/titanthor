      ...
      >
        <div className="max-w-4xl w-full p-8">
          <div className="bg-white rounded-xl shadow-2xl p-8">
            ...
            >
              Happy Birthday To the most beautiful girlll!
            </motion.h3>
            ...
            >
              May your day be as wonderful and special as you are. Thank you for being a supportive person and bringing so much happiness to me.
            </motion.p>
